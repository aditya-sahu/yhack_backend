...
from podcast_module.pod import extract_text_from_pdf, get_conversation, text_to_speech_gtts
from brainrot_module.brainrot import extract_text_from_pdf_brainrot, modify_video, openai_sequence_response
...
UPLOAD_FOLDER = 'podcast_module/uploads'
